...
Namespace RDotNet
    ...
    Public Class CharacterVector
        ...
        ''' <seealsocref="REngineExtension.CreateCharacterVector(REngine,Integer)"/>
        ...
        ''' <seealsocref="REngineExtension.CreateCharacterVector(REngine,IEnumerable(OfString))"/>
        ...
        ''' </summary>
        ''' <paramname="engine">The <seecref="REngine"/> handling this instance.</param>
        ''' <paramname="coerced">The pointer to a string vector.</param>
