...
Namespace RDotNet
    ...
    Public Class CharacterMatrix
        ...
        ''' <seealsocref="REngineExtension.CreateCharacterMatrix(REngine,Integer,Integer)"/>
        ...
        ''' <seealsocref="REngineExtension.CreateCharacterMatrix(REngine,)"/>
        ...
        ''' </summary>
        ''' <paramname="engine">The <seecref="REngine"/> handling this instance.</param>
        ''' <paramname="coerced">The pointer to a string matrix.</param>
