...
Public Class NumericMatrix
    ...
    ''' <seealsocref="REngineExtension.CreateNumericMatrix(REngine,Integer,Integer)"/>
    ...
    ''' <seealsocref="REngineExtension.CreateNumericMatrix(REngine,)"/>
    ...
    ''' </summary>
    ''' <paramname="engine">The <seecref="REngine"/> handling this instance.</param>
    ''' <paramname="coerced">The pointer to a numeric matrix.</param>
