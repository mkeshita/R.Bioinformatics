...
Namespace RDotNet
    ...
    Public Class ComplexVector
        ...
        ''' <seealsocref="REngineExtension.CreateComplexVector(REngine,Integer)"/>
        ...
        ''' <seealsocref="REngineExtension.CreateComplexVector(REngine,System.Collections.Generic.IEnumerable(OfSystem.Numerics.Complex))"/>
        ...
        ''' </summary>
        ''' <paramname="engine">The <seecref="REngine"/> handling this instance.</param>
        ''' <paramname="coerced">The pointer to a complex number vector.</param>
