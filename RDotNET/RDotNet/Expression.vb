...
Imports System.Runtime.InteropServices
    ...
    Public Class Expression
        ...
        ''' <paramname="pointer">The pointer to an expression.</param>
        ...
        ''' </summary>
        ''' <paramname="environment">The environment.</param>
        ...
        ''' </summary>
        ''' <paramname="environment">The environment.</param>
        ''' <paramname="result">The evaluation result, or <c>null</c> if the evaluation failed</param>
