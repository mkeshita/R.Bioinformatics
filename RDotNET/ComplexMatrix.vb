...
Namespace RDotNet
    ...
    Public Class ComplexMatrix
        ...
        ''' <seealsocref="REngineExtension.CreateComplexMatrix(REngine,Integer,Integer)"/>
        ...
        ''' <seealsocref="REngineExtension.CreateComplexMatrix(REngine,)"/>
        ...
        ''' </summary>
        ''' <paramname="engine">The <seecref="REngine"/> handling this instance.</param>
        ''' <paramname="coerced">The pointer to a complex number matrix.</param>
